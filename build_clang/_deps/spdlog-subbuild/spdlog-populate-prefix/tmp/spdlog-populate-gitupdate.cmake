...
execute_process(
  COMMAND "/home/schrieffer/.git-ai/bin/git" --git-dir=.git show-ref "v1.13.0"
  WORKING_DIRECTORY "/home/schrieffer/LiteVO/build_clang/_deps/spdlog-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/schrieffer/LiteVO/build_clang/_deps/spdlog-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/schrieffer/LiteVO/build_clang/_deps/spdlog-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
