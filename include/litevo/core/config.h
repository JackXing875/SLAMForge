// =============================================================================
// LiteVO configuration system — YAML-based runtime parameter management
// =============================================================================
...
struct LoopClosingConfig {
    bool   enabled               = false;  ///< Enable loop closing (needs DBoW2)
...
/// @brief Top-level LiteVO system configuration.
struct SystemConfig {
    CameraConfig       camera;
    OrbConfig          orb;
